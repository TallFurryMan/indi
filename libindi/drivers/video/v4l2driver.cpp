...
bool V4L2_Driver::setManualExposure(double duration)
{
  ...
  /* Update exposure duration in client - hardcoded 5 seconds */
  if(5.0f < duration)
    IEAddTimer(5000, (IE_TCF *)stdtimerCallback, this);
